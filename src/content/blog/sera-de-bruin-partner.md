---
title: "De liefde van SERA de Bruin: dit is haar partner Tess Korevaar"
slug: "sera-de-bruin-partner"
description: "Benieuwd met wie SERA de Bruin haar leven deelt? Leer alles over haar partner Tess Korevaar, hun relatie en hoe deze liefde haar muziek beïnvloedt."
excerpt: "De liefde van SERA de Bruin: dit is haar partner Tess Korevaar View this post on Instagram A post shared by SERA (@sera_i_am) SERA, de"
pubDate: "2025-04-30T06:04:20.000Z"
date: "2025-04-30T06:04:20.000Z"
updatedDate: "2025-06-26T14:29:43.000Z"
draft: false
...
<div data-elementor-type="wp-post" data-elementor-id="482" class="elementor elementor-482" data-elementor-post-type="post">
			...
			<div class="elementor-widget-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
					<h1 class="elementor-heading-title elementor-size-default">De liefde van SERA de Bruin: dit is haar partner Tess Korevaar
</h1>				</div>
				</div>
				...
				<div class="elementor-widget-container">
									<p class="" data-start="645" data-end="1062">SERA, de zangeres die de harten van Nederland veroverde via TikTok en haar deelname aan <em data-start="733" data-end="748">Beste Zangers</em>, houdt haar privéleven meestal vrij bescheiden. Toch is er één persoon die een constante rol speelt achter de schermen én soms zelfs voor de camera: haar partner Tess Korevaar. In dit artikel duiken we dieper in wie Tess is, hoe hun relatie ontstond, en welke invloed deze liefdevolle band heeft op SERA’s muziek.</p><h2 class="" data-start="1064" data-end="1105"> </h2>								</div>
				</div>
				...
				<div class="elementor-widget-container">
					<h2 class="elementor-heading-title elementor-size-default">Hoe SERA en Tess elkaar leerden kennen
</h2>				</div>
				</div>
				...
				<div class="elementor-widget-container">
									<p class="" data-start="1107" data-end="1426">Het begon allemaal op een vrij moderne manier: via social media. SERA deelde haar zangkunsten online, Tess Korevaar viel op haar muzikaliteit én uitstraling. Ze begonnen te praten, het klikte meteen en van daaruit groeide iets moois. Inmiddels zijn de twee al bijna zes jaar samen en wonen ze samen met hun hondje Buck.</p><p class="" data-start="1428" data-end="1677">Tess is niet alleen SERA’s vriendin, maar ook haar beste vriendin en vaste steunpilaar. Ze is bij elk belangrijk moment aanwezig, zowel privé als in SERA’s carrière. Denk aan premières, optredens of nerveuze studiomomenten: Tess staat altijd paraat.</p>								</div>
				</div>
				<div class="elementor-element elementor-element-a9403ed elementor-widget elementor-widget-heading" data-id="a9403ed" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
				<div class="elementor-widget-container">
					<h2 class="elementor-heading-title elementor-size-default">Tess Korevaar: meer dan een vriendin
</h2>				</div>
				</div>
				<div class="elementor-element elementor-element-1e4add2 elementor-widget elementor-widget-text-editor" data-id="1e4add2" data-element_type="widget" data-e-type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
									<p class="" data-start="1720" data-end="1981">Tess Korevaar is fotografe van beroep. Ze specialiseert zich in lifestyle- en evenementenfotografie, en heeft inmiddels ook haar stempel gedrukt op de visuele identiteit van SERA. Veel van de professionele foto’s op SERA’s social media zijn door haar geschoten.</p><p class="" data-start="1983" data-end="2320">Wat hun relatie extra bijzonder maakt, is dat Tess niet alleen de liefde van haar leven is, maar ook een creatieve sparringpartner. SERA heeft in verschillende interviews aangegeven dat Tess vaak als eerste haar nieuwe muziek mag horen en eerlijk feedback geeft. Hun band is niet alleen liefdevol, maar ook inspirerend op artistiek vlak.</p>								</div>
				</div>
				...
				<div class="elementor-widget-container">
					<h3 class="elementor-heading-title elementor-size-default">Muziek met een persoonlijke boodschap
</h3>				</div>
				</div>
				...
				<div class="elementor-widget-container">
									<p class="" data-start="2364" data-end="2737">SERA staat bekend om haar oprechte en gevoelige teksten. In meerdere van haar nummers hoor je verwijzingen naar liefde, zelfacceptatie en verbinding – thema’s die direct voortkomen uit haar relatie met Tess. Een krachtig voorbeeld is het nummer “She Kissed Me First”, waarin SERA openhartig zingt over haar liefde voor een vrouw en hoe die eerste kus haar leven veranderde.</p><p class="" data-start="2739" data-end="2988">Dankzij haar relatie met Tess durft SERA haar hart te laten spreken. Ze draagt daarmee bij aan zichtbaarheid en acceptatie van de LGBTQ+-gemeenschap, zonder dat het geforceerd voelt. Juist door haar authenticiteit weet ze een breed publiek te raken.</p>								</div>
				</div>
				<div class="elementor-element elementor-element-18c1b4a elementor-widget elementor-widget-heading" data-id="18c1b4a" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
				<div class="elementor-widget-container">
					<h3 class="elementor-heading-title elementor-size-default">Een liefde die ook professioneel werkt
</h3>				</div>
				</div>
				<div class="elementor-element elementor-element-b8551ce elementor-widget elementor-widget-text-editor" data-id="b8551ce" data-element_type="widget" data-e-type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
									<p class="" data-start="3033" data-end="3326">In de entertainmentwereld is het niet vanzelfsprekend dat een artiest zijn of haar partner betrekt bij het creatieve proces. Toch lijkt het voor SERA en Tess moeiteloos te gaan. Ze inspireren elkaar, steunen elkaar en bouwen samen aan een merk dat niet alleen muzikaal, maar ook visueel klopt.</p><p class="" data-start="3328" data-end="3656">Hoewel Tess zelf liever uit de spotlights blijft, is haar aanwezigheid voelbaar in alles wat SERA doet. Achter elk optreden, elke videoclip en elke release zit een stukje van hun gezamenlijke reis. Het duo bewijst dat liefde niet alleen privé, maar ook professioneel een onuitputtelijke bron van kracht en creativiteit kan zijn.</p>								</div>
				</div>
