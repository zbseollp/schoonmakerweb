---
title: "Chris Woerts en zijn partner: een discreet liefdesleven achter de schermen"
slug: "chris-woerts-partner"
description: "Heeft Chris Woerts een partner? Lees hier hoe de sportmarketeer zijn privéleven afschermt, zijn eerdere relatieverleden en wat bekend is over zijn gezin."
excerpt: "Chris Woerts en zijn partner: een discreet liefdesleven achter de schermen Chris Woerts is niet weg te denken uit de wereld van sportmarketing en televisie."
pubDate: "2025-05-15T13:01:48.000Z"
date: "2025-05-15T13:01:48.000Z"
updatedDate: "2025-06-26T14:30:07.000Z"
draft: false
...
<div data-elementor-type="wp-post" data-elementor-id="537" class="elementor elementor-537" data-elementor-post-type="post">
			...
			<div class="elementor-widget-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
					<h1 class="elementor-heading-title elementor-size-default">Chris Woerts en zijn partner: een discreet liefdesleven achter de schermen</h1>				</div>
				</div>
				...
				<div class="elementor-widget-container">
									<p>Chris Woerts is niet weg te denken uit de wereld van sportmarketing en televisie. Hij schuift geregeld aan bij talkshows als analyticus en vertelt vol flair over commercie, sport en de media. Toch houdt hij zijn privéleven opvallend buiten beeld. Wat weten we eigenlijk over zijn partner en gezin?</p>								</div>
				</div>
				...
				<div class="elementor-widget-container">
					<h2 class="elementor-heading-title elementor-size-default">Een samengesteld gezin</h2>				</div>
				</div>
				<div class="elementor-element elementor-element-0da3c4f elementor-widget elementor-widget-text-editor" data-id="0da3c4f" data-element_type="widget" data-e-type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
									<p class="" data-start="1058" data-end="1470">Chris Woerts heeft in het verleden een relatie gehad met een vrouw met wie hij een samengesteld gezin vormde. Zij bracht een dochter mee uit een eerdere relatie en samen woonden ze jarenlang in Barendrecht. Daarnaast heeft Chris zelf een zoon. De kinderen zijn inmiddels volwassen en uit huis, wat hem ruimte geeft voor een leven dat minder in het teken staat van opvoeden, maar wel van betrokkenheid op afstand.</p><p class="" data-start="1472" data-end="1760">Hoewel hij zijn gezin zelden benoemt in interviews, is duidelijk dat familie voor hem een belangrijke basis vormt. De balans tussen carrière en privé is voor Woerts altijd belangrijk geweest, en hij weet zijn persoonlijke omgeving zorgvuldig te beschermen tegen publieke nieuwsgierigheid.</p>								</div>
				</div>
				<div class="elementor-element elementor-element-7ee33ff elementor-widget elementor-widget-video" data-id="7ee33ff" data-element_type="widget" data-e-type="widget" data-settings="{&quot;youtube_url&quot;:&quot;https:\/\/youtu.be\/Yunab95E_hs&quot;,&quot;video_type&quot;:&quot;youtube&quot;,&quot;controls&quot;:&quot;yes&quot;}" data-widget_type="video.default">
				<div class="elementor-widget-container">
							<div class="elementor-wrapper elementor-open-inline">
			<div class="elementor-video"></div>		</div>
						</div>
				</div>
				<div class="elementor-element elementor-element-14d4d76 elementor-widget elementor-widget-heading" data-id="14d4d76" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
				<div class="elementor-widget-container">
					<h2 class="elementor-heading-title elementor-size-default">Geen recente informatie over een partner</h2>				</div>
				</div>
				...
				<div class="elementor-widget-container">
									<p>Over zijn huidige relatiestatus is vrijwel niets bekend. De eerdere relatie met zijn vrouw is inmiddels voorbij, maar of hij op dit moment opnieuw een partner heeft, blijft onduidelijk. Woerts kiest er bewust voor om deze kant van zijn leven privé te houden. In een wereld waarin veel BN’ers hun liefdesleven breed uitmeten, valt zijn discretie op. Hij lijkt zich beter thuis te voelen in de rol van waarnemer dan die van onderwerp.</p>								</div>
				</div>
				...
				<div class="elementor-widget-container">
					<h2 class="elementor-heading-title elementor-size-default">Focus op werk en netwerk</h2>				</div>
				</div>
				<div class="elementor-element elementor-element-59438b4 elementor-widget elementor-widget-text-editor" data-id="59438b4" data-element_type="widget" data-e-type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
									<p>Zijn focus ligt vooral op zijn professionele netwerk, zijn optredens op televisie en zijn advieswerk in de sportwereld. Het gezelschap waarin hij zich beweegt – van bestuurders tot oud-voetballers – lijkt hem prima te passen. Daar is hij zichtbaar, gevat en inhoudelijk sterk. In de liefde kiest hij voor rust, anonimiteit en bescherming van wat voor hem privé is.</p>								</div>
				</div>
				<div class="elementor-element elementor-element-d8c4132 elementor-widget elementor-widget-heading" data-id="d8c4132" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
				<div class="elementor-widget-container">
					<h2 class="elementor-heading-title elementor-size-default">Een man die zijn grenzen bewaakt</h2>				</div>
				</div>
				...
				<div class="elementor-widget-container">
									<p>Chris Woerts is een publieke man die zijn grenzen scherp bewaakt. Zijn strategische aanpak is niet alleen zichtbaar in zijn carrière, maar ook in de manier waarop hij zijn persoonlijke leven afschermt. Over zijn liefdesleven spreekt hij weinig – misschien juist omdat de rust thuis een tegenwicht biedt aan het rumoer van televisie, voetbal en media.</p>								</div>
				</div>
